...
2. **Anchor Extraction**: Co-occurrence analysis on parallel texts to identify Egyptian-English word pairs with >30% conditional probability

3. **Alignment**: Ridge regression (α=1.0) to learn transformation from Egyptian 768d space to English GloVe 300d space

4. **Projection**: All 80,662 Egyptian vectors transformed to GloVe space and L2-normalized
...
This is V9 of the Heiroglyphy project, representing the culmination of multiple alignment approaches:
