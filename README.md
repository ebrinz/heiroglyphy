...
The project includes pipelines for generating a video explainer (Manim), audio narration (OpenAI TTS), and PDF publications (XeLaTeX).

> **See [`docs/README.md`](docs/README.md)** for full setup instructions, system dependencies, and step-by-step generation guides.
