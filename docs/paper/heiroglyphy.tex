...
\usepackage{enumitem}
\usepackage{float}
% \usepackage{microtype}  % requires full TeX install with scalable fonts
...
\author{
    Erik Brinsmead\textsuperscript{1} \and Claude\textsuperscript{2} \\[6pt]
    \textsuperscript{1}Independent Researcher \\
    \textsuperscript{2}Anthropic \\[6pt]
...
\subsection{Gold Is Divine Flesh}
...
\subsection{Silence Is the Condition of the Dead}
...
\subsection{Seeing Was an Act of Magical Power}
...
\subsection{The Snake Is Divine, Not Wise}
...
\subsection{Temple Is to House as God Is to Man}
...
\subsection{Mother Is Royalty, Not Earth}
...
\subsection{Truth and Power Are the Same Force}
...
\subsection{Love and Fear Meet at Eternity}
