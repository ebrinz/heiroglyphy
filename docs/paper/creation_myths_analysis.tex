...
{\color{passage}\textit{``nn p,t nn tꜣ nn wnn rmṯ''}\\
...
{\color{passage}\textit{``wnn≡j m Nwn m nn,w''}\\
...
{\color{passage}\textit{``jšš≡j m Šw tf≡j m Tfn,t''}\\
...
{\color{passage}\textit{``ḥkꜣ pw ḥnꜥ≡j''}\\
...
{\color{passage}\textit{``ḥḥ,w m ḫpr,w≡j''}\\
...
{\color{passage}\textit{``Ḏd-mdw jnk Jtm ḫpr ḏs≡f''}\\
...
{\color{passage}\textit{``Jtm pw --- Rꜥ pw m ḫꜥ≡f m zp-tp,j m ḥq,ꜣ m Wnw''}\\
...
{\color{passage}\textit{``zp-tp,j pw --- Nwn pw''}\\
...
{\color{passage}\textit{``Wsjr pw --- ḏ,t pw nḥḥ pw''}\\
...
{\color{passage}\textit{``bꜣ pw --- ꜣḫ pw''}\\
...
{\color{passage}\textit{``wbn≡k nfr m ꜣḫ,t n,t p,t --- jtn ꜥnḫ''}\\
...
{\color{passage}\textit{``ḥtp≡k m ꜣḫ,t n,t p,t --- tꜣ m kkw m snn n mwt''}\\
...
{\color{passage}\textit{``swḥ,t --- dj≡k ṯꜣw r sꜥnḫ jr,t.n≡k nb,t''}\\
...
{\color{passage}\textit{``tꜣ.w nb.w ḫꜣs,wt nb,t --- qmꜣ.n≡k ꜥnḫ≡sn''}\\
...
{\color{passage}\textit{``jtn ꜥnḫ nn k,j ḫr≡k''}\\
...
{\color{passage}\textit{``jr,t≡k --- rmṯ ḫpr''}\\
...
{\color{passage}\textit{``ḫpr≡j m ḫpr --- ḫpr.kwj ḫpr ḫpr,w ḫpr nb ḫpr m-ḫt ḫpr≡j''}\\
...
{\color{passage}\textit{``sḫpr≡j m jb≡j --- qmꜣ.n≡j ḫpr,w≡j nb''}\\
...
{\color{passage}\textit{``wꜥ.kwj wnn.kwj m Nwn --- nn gm.n≡j s,t ꜥḥꜥ≡j jm''}\\
...
{\color{passage}\textit{``jr,t≡j sḫpr rmṯ --- rm,j pr m jr,t≡j ḫpr m rmṯ''}\\
...
{\color{passage}\textit{``Šw ḥnꜥ Tfn,t --- sḫpr≡sn Mꜣꜥ,t''}\\
